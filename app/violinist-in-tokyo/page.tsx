...
const Home = () => {
    return (
        <>
            <div className="z-0 flex h-[100vh] w-[100vw] -translate-y-[0px] flex-col justify-stretch overflow-hidden bg-[url('/coverPhotoHome.jpg')] bg-cover bg-no-repeat pb-5">
                <Navbar />
