...
const Presenter = () => {
	...
	return (
		<PageLayout title={t('title')} backgroundImageUrl="/netherlandsViolin.jpg">
			...
			<PlainTextSection
				title={t('intro')}
				paragraphs={[t('intro1'), t('intro2'), t('intro3')]}
			/>
			<ImageSection src="/cocktailHour.jpg" alt={t('cocktailHourAlt')} />
			<PlainTextSection
				title={t('ensembleOptions')}
				paragraphs={[t('ensembleOptionsParagraph')]}
			/>
			<Tabs tabs={tabs} />
			<PlainTextSection title={t('receiveQuote')}>
				{formatTranslation(t('receiveQuoteParagraph'))}
			</PlainTextSection>
			<PlainTextSection marginSize="small">
				{formatTranslation(t('relatedLinks'))}
			</PlainTextSection>
		</PageLayout>
	);
};
