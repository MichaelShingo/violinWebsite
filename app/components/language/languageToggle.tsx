...
const LanguageToggle: FC = () => {
    ...
    return (
        <div onClick={handleClick} className="group pointer-events-auto fixed bottom-0 right-0 z-[1000] -m-1 flex h-[75px] w-[100px] scale-90 items-center justify-center rounded-full bg-transparent p-0 sm:m-3 sm:scale-100">
