...
const Footer = () => {
    return (
        <div className="-z-[10] flex h-dvh w-full flex-col justify-between bg-primary px-36 py-12">
            ...
            <div className="">
                <h5 className="text-xl pt-5 text-center"><b>{`Copyright © ${new Date().getFullYear()}`}</b><br></br> Web Design by <GreenText>Michael Shingo Crawford</GreenText></h5>
