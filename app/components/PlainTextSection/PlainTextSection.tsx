...
import Typography, { TypographyVariant } from '../text/Typography';
...
const PlainTextSection: FC<PlainTextSectionProps> = ({
	title,
	titleVariant = 'h2',
	paragraphs,
	children,
	...
	return (
		...
		>
			<div className="max-w-[1200px]">
				...
				{children && <Typography variant="p">{children}</Typography>}
			</div>
		</section>
	);
};
