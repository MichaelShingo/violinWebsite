			...
			case 'h1':
				res = (
					<motion.h1
						className={twJoin([
							...cn,
							'w-full text-[2rem] sm:text-[4rem] md:text-[6rem] lg:text-[8rem] uppercase',
						])}
					>
						{children}
					</motion.h1>
			...
			case 'h2':
				res = (
					<motion.h2
						...
						className={twJoin([
							...cn,
							'my-8 text-4xl sm:text-5xl md:text-6xl lg:text-6xl xl:text-8xl uppercase',
						])}
					>
						{children}
					</motion.h2>
			...
			case 'h3':
				res = (
					<motion.h3
						...
						initial={{ opacity: '0%' }}
						whileInView={{ opacity: '100%' }}
						className={twJoin([...cn, 'my-3 text-3xl sm:text-5xl lg:text-6xl uppercase'])}
					>
						{children}
					</motion.h3>
				);
			...
			case 'h4':
				res = (
					<motion.h4
						...
						className={twJoin([
							...cn,
							'my-2 text-sm sm:text-base md:text-lg text-black first-letter:uppercase',
						])}
					>
						{children}
					</motion.h4>
			...
			case 'p':
				res = (
					<p
						className={twJoin([
							...cn,
							'text-base font-thin text-black md:text-2xl',
							paragraphFont,
						])}
					>
						{children}
